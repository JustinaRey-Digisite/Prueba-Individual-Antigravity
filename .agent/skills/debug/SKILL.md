...
2. **Análisis de Logs**: Solicitar logs de BullMQ o de la consola de NestJS[cite: 2].
...
## Verificación de Webhooks [cite: 2]
Si el error es de integración, verificar la firma HMAC y la lógica de reintento[cite: 2].